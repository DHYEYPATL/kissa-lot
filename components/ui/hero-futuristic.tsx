...
export const HeroFuturistic = () => {
  ...
  useEffect(() => {
    // Client-side only: generate randomized glitch delays
  ...
  return (
    <div className="h-svh relative w-full overflow-hidden bg-black">
      ...
      <button
        className="explore-btn absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2 text-white/80 hover:text-white transition-colors"
